...
public class activity_reading_answers extends AppCompatActivity {
    ...
    public void showReading(int cout, ArrayList<Reading> rd){
        ...
        if(cout == rd.size()) {
            Intent intent=new Intent(activity_reading_answers.this, MainActivity.class);
    ...
    public void showanswer(){
        Toast.makeText(activity_reading_answers.this, "Ba già m", Toast.LENGTH_SHORT).show();
        if(ketqua.equals("A")) {
